...
public class PruebaAgenda{
  public PruebaAgenda(){
    ...
    System.out.println(miAgenda.getCapacidad());
    ...
    System.out.println(miAgenda.buscar(alvaro));
    System.out.println(miAgenda.buscar(oscar));
    System.out.println(miAgenda.buscar(ana));

    System.out.println(miAgenda.buscar("Rodrigo"));
    System.out.println(miAgenda.buscar("jtv@gmail.com"));
    System.out.println(miAgenda.buscar("Guardia"));
